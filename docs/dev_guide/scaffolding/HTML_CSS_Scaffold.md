...
Use this document when regenerating the base UI from scratch. It captures the design tokens, layout defaults, and breakpoint rules that the initial build used. Day-to-day maintenance work should refer to `../HTML_CSS_Guide.md`, while this file is for scaffolding or large visual refreshes.
