...
### Maintainer ([`Maintainer`](../flipfix/apps/accounts/models.py))
...
### Machine Model ([`MachineModel`](../flipfix/apps/catalog/models.py))
...
### Log Entry Media ([`LogEntryMedia`](../flipfix/apps/maintenance/models.py))

Photos/videos attached to log entries.

## Parts app

### Part Request ([`PartRequest`](../flipfix/apps/parts/models.py))
...
### Part Request Media ([`PartRequestMedia`](../flipfix/apps/parts/models.py))

Photos/videos attached to part requests.

### Part Request Update ([`PartRequestUpdate`](../flipfix/apps/parts/models.py))

Comment or status update on a part request. Can optionally change the part request's status.

### Part Request Update Media ([`PartRequestUpdateMedia`](../flipfix/apps/parts/models.py))

Photos/videos attached to part request updates.

## Wiki app

### Wiki Page ([`WikiPage`](../flipfix/apps/wiki/models.py))

A wiki page with markdown content. Pages are identified by slug derived from title.

### Wiki Page Tag ([`WikiPageTag`](../flipfix/apps/wiki/models.py))
...
### Wiki Tag Order ([`WikiTagOrder`](../flipfix/apps/wiki/models.py))

Optional explicit ordering for tags in navigation. Tags without entries sort alphabetically.

### Template Option Index ([`TemplateOptionIndex`](../flipfix/apps/wiki/models.py))
...
### Discord User Link ([`DiscordUserLink`](../flipfix/apps/discord/models.py))
