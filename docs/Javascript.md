...
container.dispatchEvent(
  new CustomEvent('maintainer:selected', {
...
| `machine:changed`     | machine_autocomplete.js             | template_selector.js    | Machine selected; refetch templates (`detail: { slug, locationSlug }`) |
