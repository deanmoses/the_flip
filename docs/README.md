...
- **[Forms.md](Forms.md)** - Form building patterns, components, optional field marking, and CSS classes
- **[Django_Python.md](Django_Python.md)** - Django app structure, Python conventions, view patterns, and code organization
