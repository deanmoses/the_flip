...
There's a big distinction in the maintenance workflows between machines in service, machines in the workshop, and machines in storage.

### 1. Machines in Service

Museum visitors must be able to report problems easily (such as via a QR code) and we want to jump on them quickly. These are the most urgent.
