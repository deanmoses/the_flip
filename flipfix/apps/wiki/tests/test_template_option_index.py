...
from flipfix.apps.wiki.actions import sync_template_option_index
from flipfix.apps.wiki.models import TemplateOptionIndex, WikiPage
...
class SyncCalledOnFormSaveTests(TestDataMixin, TestCase):
    ...
    def test_form_save_creates_index(self):
        ...
        from flipfix.apps.wiki.forms import WikiPageForm
